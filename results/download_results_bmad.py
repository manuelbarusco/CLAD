...
strategies = ["multi_task", "single_model", "naive", "cl"]
            ...
            for run in tqdm(runs): 
                ...
                for metric in metrics: 
                    ...
                    if metric == "Summary/evaluation_ad/f1_img": 
                        if (strategy in ["cl", "naive"] ) and last_task_perf_multi: 
...
def main():
    ...
    #table_df.to_csv(f'csv/final_table_bmad.csv', index=False)
